...
This workflow note has explored the yield, partial profit, and risk implications of wheat varietal and planting date choices from a 5-year agronomic experiment (2016/17 to 2020/21) in 8 districts in the Eastern part of India, Bihar.  We found that sowing wheat in early November using a long duration variety HD 2967 gives the highest agronomic returns for a risk neutral farmer. With some risk aversion, farmers would opt for more diversified varieties but mostly with early planting.

# References

Barkley, A., Peterson, H.H., and Shroyer, J. 2010. \"Wheat variety selection to maximize returns and minimize risk: An application of portfolio theory.\" *Journal of Agricultural and Applied Economics* 42(1): 39-55. Doi: <https://doi.org/10.1017/S107407080000328X>.
